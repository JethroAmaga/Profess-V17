...
const SCENES = {
  ...
  social: [
    ...
    { id: "situational",   top: "#33222E", bottom: "#100A10", floor: "#C8789A", mote: "#D898AE", // dusk party
      backdrop: ["relationship.jpg"] }, // closest match — no dedicated shoot
  ],
};
