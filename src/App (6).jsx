...
export default function Profess() {
  ...
  if (screen === "landing") {
    ...
    const panelCharAbout = buildSVG(generateChar(pick(["interviewer","journalist","colleague","friend_female"])), "neutral", false);
    ...
    return (
      <div className="screen-enter" style={{ ...BASE, overflowY:"auto" }}>
        <style>{css}</style>
        ...
        <div style={{ position:"relative", height:"100vh", display:"flex", flexDirection:"column", overflow:"hidden" }}>
          ...
          <div style={{ display:"flex", justifyContent:"center", alignItems:"flex-end", gap:"clamp(16px,4vw,56px)", padding:"0 40px 0", position:"relative", zIndex:2, flexShrink:0 }}>
            {heroChars.map((svg, i) => (
              <div key={i} style={{ width:"80px", height:"100px", opacity:.10, flexShrink:0 }}
        ...
        <div style={{ position:"relative", background:"#060606", backgroundImage:"radial-gradient(circle, #1C1C1C 1px, transparent 1px)", backgroundSize:"24px 24px", borderTop:"1px solid #141414" }}>
          ...
          <div style={{ display:"flex", borderBottom:"1px solid #141414" }}>
            ...
            <button onClick={() => setScreen("lang")}
              ...
              <div className="panel-char" style={{ width:"140px", opacity:.85, transition:"opacity .25s", marginBottom:"32px" }}
            ...
            <button onClick={() => setExpandedPanel(p => p==="terms" ? null : "terms")}
              ...
              <div style={{ display:"flex", flexDirection:"column", alignItems:"center", marginBottom:"32px" }}>
                <div className="panel-char" style={{ width:"140px", opacity:.85, transition:"opacity .25s" }}
