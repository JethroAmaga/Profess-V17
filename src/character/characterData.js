...
const OUTFIT_FAMILIES = {
  formal: ["#4A3826","#3E2E20","#54402A","#362A1E","#46341F","#3A2C1C"],
  social: ["#4A2620","#3E2422","#522A24","#3A2220","#44241E","#3C201C"],
};
...
const generateChar = (roleKey, forcedGender = null, mode = "formal") => {
  ...
  return { name, gender, ethnicity: eth, roleKey, accent: ACCENTS[eth]||"#C8B89A", bg: BGS[eth]||"#161410", skin, hair, hairLong, hairStyle, glasses, beard, bodyColor, trim, tie, outfitStyle };
};
...
const CHARS = {
  default: {
    ...
    bodyColor:"#5C4E3C", trim:"#D9A05C", tie:null, isCoach:true,
  },
};
