...
export default function Profess() {
  ...
  if (screen === "landing") {
    const heroChars = [
      buildSVG(CHARS.default, "neutral", false),
      buildSVG(generateChar("journalist"), "neutral", false),
      buildSVG(generateChar("friend_female"), "neutral", false),
      buildSVG(generateChar("judge"), "neutral", false),
    ];
    const livingRoomMale = buildSVG(generateChar("friend_male"), warmMode ? "warm" : "neutral", false);
    const livingRoomFemale = buildSVG(generateChar("friend_female"), warmMode ? "warm" : "neutral", false);
    ...
    return (
      <div className="screen-enter" style={{ ...BASE, overflowY:"auto", filter:warmMode?"sepia(0.08) saturate(1.1) brightness(0.98)":"none", transition:"filter 1.2s ease" }}>
        <style>{css}</style>
        ...
        <div style={{ position:"relative", height:"100vh", display:"flex", flexDirection:"column", overflow:"hidden" }}>
          ...
          <div style={{ position:"absolute", right:0, top:0, height:"100%", width:"45%", opacity: warmMode ? 0.28 : 0.18, transition:"opacity 1.2s ease", pointerEvents:"none", zIndex:1 }}>
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
              ...
              {/* Left character */}
              <foreignObject x="10" y="32" width="20" height="30" overflow="visible">
              ...
              {/* Right character */}
              <foreignObject x="62" y="34" width="18" height="28" overflow="visible">
              ...
              {/* Lamp glow (warmMode) */}
              {warmMode && <circle cx="50" cy="50" r="13" fill="url(#lampGlow)" opacity="0.6"/>}
              {/* Lamp shade */}
          ...
          {/* Lamp click overlay — lamp sits at ~50% x of the right-45% illustration, ~51-68% y of hero */}
          <div onClick={() => setWarmMode(w => !w)} title="Toggle warm light" style={{ position:"absolute", right:"22%", top:"51%", width:"6%", height:"16%", cursor:"pointer", zIndex:5, transform:"translateX(50%)" }}/>

          {/* Hero content */}
          <div style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"flex-start", justifyContent:"center", padding:"0 40px 0 clamp(40px,8vw,140px)", position:"relative", zIndex:2 }}>
          ...
          <div style={{ display:"flex", justifyContent:"center", alignItems:"flex-end", gap:"clamp(16px,4vw,56px)", padding:"0 40px 0", position:"relative", zIndex:2, flexShrink:0 }}>
            {heroChars.map((svg, i) => {
              ...
              return <div key={i} style={{ width:"80px", height:"100px", opacity:.10, flexShrink:0, animation:heroAnims[i] }} dangerouslySetInnerHTML={{ __html: svg }}/>;
            })}
          </div>
        </div>
