    ...
    if (stage === "intro") return (
      <Overlay width="min(560px, 88vw)" align="center" placement="top-center" footer={
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.15 }}
          ...
          <span style={{ fontSize: "10.5px", letterSpacing: ".14em", textTransform: "uppercase", color: "#B3A58E" }}>
        ...
        <motion.h1
          ...
          style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontWeight: 400, fontSize: "clamp(38px,9vw,84px)", color: "#F5F2EC", marginBottom: "4px", letterSpacing: "-0.025em", lineHeight: 1.05,
        ...
        <motion.p initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }}
          ...
          style={{ color: "#F0EBE2", fontSize: "14px", lineHeight: 1.9, maxWidth: "38ch", margin: "0 auto", textShadow: "0 2px 16px rgba(0,0,0,.5)" }}>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.6 }}
          ...
          {[
            ...
            <button key={key} className="footer-link" onClick={() => setInfoPanel(key)}
              style={{ background: "none", border: "none", color: "#B3A58E", fontSize: "11px", letterSpacing: ".05em",
                textTransform: "uppercase", padding: 0, cursor: "pointer" }}
              onMouseEnter={(e) => e.currentTarget.style.color = sessionAccent}
              onMouseLeave={(e) => e.currentTarget.style.color = "#B3A58E"}>
              {label}
            </button>
          ))}
