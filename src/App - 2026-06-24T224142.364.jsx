...
export default function Profess() {
  ...
  const progressDots = () => {
    ...
    return (
      <div style={{ marginBottom: "22px" }}>
        ...
        <span style={{ fontSize: "10px", letterSpacing: ".08em", textTransform: "uppercase", color: "#FFF" }}>
  ...
  const backBtn = (to) => (
    <motion.button onClick={() => setStage(to)}
      ...
      style={{ background: "none", border: "none", color: "#FFF", fontSize: "10px", letterSpacing: ".08em", textTransform: "uppercase", display: "flex", alignItems: "center", gap: "5px", padding: 0, marginBottom: "18px" }}>
      <IconArrowLeft /> Back
    </motion.button>
  );
  ...
  const ChoiceRow = ({ onClick, accent, children, sub, bars, preview }) => (
    <motion.button onClick={() => { playSfx("select"); onClick?.(); }} variants={listItemV}
      ...
      style={{ display: "block", width: "100%", textAlign: "left", background: "none", border: "none", padding: "9px 0 9px 16px",
        borderLeft: `1px solid #3A3A3A`, position: "relative" }}>
      <span style={{ position: "absolute", left: "-1px", top: 0, bottom: 0, width: "1px", background: "#FFF",
        transform: "scaleY(var(--c, 0))", transformOrigin: "top", transition: "transform .25s ease" }} />
      <span style={{ display: "flex", alignItems: "baseline", gap: "8px" }}>
        <span style={{ color: "#FFF", fontSize: "15px", display: "block" }}>{children}</span>
        {bars && (
          <span style={{ display: "inline-flex", gap: "3px", marginLeft: "2px" }}>
            {[1, 2, 3].map(i => (
              <span key={i} style={{ width: "4px", height: "10px", borderRadius: "1px",
                background: i <= bars ? "#FFF" : "#3A3A3A" }} />
            ))}
          </span>
        )}
      </span>
      {sub && <span style={{ color: "#FFF", fontSize: "12px", display: "block", marginTop: "2px" }}>{sub}</span>}
      {preview && (
        <span style={{ display: "block", fontFamily: "'Playfair Display',serif", fontStyle: "italic",
          fontSize: "12.5px", color: "#FFF", opacity: "var(--c, 0)", overflow: "hidden",
  ...
  function StageOverlay() {
    ...
    if (stage === "lang") return (
      <Overlay panel>
        {backBtn("intro")}
        {progressDots()}
        <h2 style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontSize: "24px", color: "#FFF", marginBottom: "20px" }}>Language</h2>
    ...
    if (stage === "mode") return (
      <Overlay panel>
        {backBtn("lang")}
        {progressDots()}
        <h2 style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontSize: "24px", color: "#FFF", marginBottom: "20px" }}>Mode</h2>
        <motion.div initial="hidden" animate="visible" variants={listContainer}>
    ...
    if (stage === "disclaimer") {
      ...
      return (
        <Overlay panel footer={
          ...
          {backBtn("mode")}
          {progressDots()}
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontSize: "22px", color: "#FFF", marginBottom: "16px" }}>{c.title}</h2>
          <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginBottom: "22px" }}>
            {c.body.map((p, i) => <p key={i} style={{ fontSize: "13px", lineHeight: 1.7, color: "#FFF" }}>{p}</p>)}
          </div>
        </Overlay>
      );
    }
    ...
    if (stage === "intensity") return (
      <Overlay panel>
        {backBtn("disclaimer")}
        {progressDots()}
        <h2 style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontSize: "22px", color: "#FFF", marginBottom: "20px" }}>{lang === "id" ? "Intensitas" : "Intensity"}</h2>
        <motion.div initial="hidden" animate="visible" variants={listContainer}>
    ...
    if (stage === "scenario") {
      ...
      return (
        <Overlay panel width="min(560px, 90vw)">
          {backBtn("intensity")}
          {progressDots()}
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontSize: "22px", color: "#FFF", marginBottom: "14px" }}>{lang === "id" ? "Skenario" : "Scenario"}</h2>
    ...
    if (stage === "summary") return (
      <Overlay panel footer={
        ...
        <h2 style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontSize: "26px", color: "#FFF", marginBottom: "16px" }}>{lang === "id" ? "Ringkasan" : "Summary"}</h2>
        <p style={{ fontSize: "13px", lineHeight: 1.8, color: "#FFF", whiteSpace: "pre-wrap" }}>{summary}</p>
      </Overlay>
    );
      ...
      <div style={{ position: "absolute", top: "max(20px, env(safe-area-inset-top))", right: "20px", zIndex: 40, display: "flex", alignItems: "center",
        ...
        {!ambientPrimed && (
          <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.5 }}
            style={{ fontSize: isMobile ? "10px" : "11px", color: "#FFF", fontWeight: 700, letterSpacing: ".02em", textAlign: "right", lineHeight: 1.3 }}>
          ...
          <motion.div
            ...
            <div style={{ position: "absolute", top: "100%", marginTop: isMobile ? "-6px" : "2px", left: "50%", transform: "translateX(-50%)", textAlign: "center", whiteSpace: "nowrap" }}>
              <TiltBox style={{ boxSizing: "border-box", padding: "5px 13px", borderRadius: "10px",
                ...
                <p style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontSize: "14px", color: "#FFF" }}>{charMeta.name || charMeta.title}</p>
                <p style={{ fontSize: "9px", color: "#FFF", marginTop: isMobile ? "0px" : "-3px" }}>{charMeta.title}</p>
                {isLeaning && <p style={{ fontSize: "10px", letterSpacing: ".08em", color: "#FFF", marginTop: "6px", textTransform: "uppercase" }}>{lang === "id" ? "mendekat..." : "leaning in..."}</p>}
              </TiltBox>
            </div>
          </motion.div>
        )}
        ...
        <>
          ...
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
            ...
            <motion.button onClick={() => setStage("intro")} whileHover={{ opacity: 0.7 }} whileTap={{ scale: 0.96 }}
              style={{ background: "none", border: "none", color: "#FFF", fontWeight: 700, fontSize: "13px", fontFamily: "'Inter',sans-serif" }}>Profess</motion.button>
            <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
              <motion.button onClick={() => setTranscriptOpen(o => !o)}
                whileHover={{ opacity: 0.7 }} whileTap={{ scale: 0.96 }}
                transition={{ duration: 0.18 }}
                style={{ background: "none", border: "1px solid #3A3A3A", borderRadius: "8px", color: "#FFF", fontWeight: 700, fontSize: "11px", padding: "6px 10px" }}>
              ...
              <motion.button onClick={() => setSpeechEnabled(s => !s)} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}
                style={{ background: "none", border: "none", color: "#FFF" }}>{speechEnabled ? <IconVolume/> : <IconMute/>}</motion.button>
              <motion.button onClick={resetSession} whileHover={{ scale: 1.1, rotate: -25 }} whileTap={{ scale: 0.9 }}
                style={{ background: "none", border: "none", color: "#FFF" }}><IconRefresh/></motion.button>
            </div>
          </motion.div>
          ...
          <AnimatePresence>
            {transcriptOpen && (
              <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }}
                ...
                {msgList()}
                {loading && <p style={{ fontSize: "12px", color: "#FFF" }}>{lang === "id" ? "..." : "thinking..."}</p>}
          ...
          <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, padding: "16px 28px 22px", zIndex: 10, background: "linear-gradient(to top, rgba(7,8,9,0.92), transparent)" }}>
            ...
            <div style={{ display: "flex", gap: "8px", alignItems: "stretch" }}>
              <textarea ref={textareaRef} value={input} onChange={handleTA} onKeyDown={handleKeyDown}
                ...
                className="input-glow" style={{ "--ac": sessionAccent, flex: 1, minHeight: "48px", maxHeight: "160px", resize: "none", background: "#1A1A1A",
                  border: isListening ? "1px solid #BC5A5A" : "1px solid #3A3A3A", borderRadius: "12px", color: "#FFF",
                  padding: "13px 14px", fontFamily: "inherit", fontSize: "14px" }} />
              {isSpeaking && <motion.button onClick={stopSpeech} whileHover={{ scale: 1.06 }} whileTap={{ scale: 0.92 }} style={{ background: "#1A1A1A", border: "1px solid #3A3A3A", borderRadius: "10px", padding: "12px", color: "#FFF" }}><IconStop/></motion.button>}
              ...
              <div style={{ display: "flex", flexDirection: "column", width: "104px", height: "48px",
                  ...
                  {lastExchange && (
                    <motion.button onClick={tryAgain} whileHover={{ opacity: 0.7 }} whileTap={{ scale: 0.95 }}
                      style={{ flex: 1, background: "none", border: "none", borderRight: `1px solid ${pillBorder}`,
                        color: "#FFF", fontWeight: 700, fontSize: "9.5px" }}>
                      {lang === "id" ? "Coba lagi" : "Try again"}
                    </motion.button>
                  )}
                  <motion.button onClick={endSession} whileHover={{ opacity: 0.7 }} whileTap={{ scale: 0.95 }}
                    style={{ flex: 1, background: "none", border: "none", color: "#FFF", fontWeight: 700, fontSize: "9.5px" }}>
                ...
                <div style={{ display: "flex", flex: 1 }}>
                  <motion.button onClick={toggleMic} className={isListening ? "mic-active" : ""} whileHover={{ opacity: 0.7 }} whileTap={{ scale: 0.95 }}
                    style={{ flex: 1, background: "none", border: "none", borderRight: `1px solid ${pillBorder}`,
                      color: "#FFF", display: "flex", alignItems: "center", justifyContent: "center" }}><IconMic/></motion.button>
