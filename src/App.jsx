...
function buildSVG(charOrKey, mood, isTalking) {
  ...
  const armL = `<ellipse cx="36" cy="136" rx="10" ry="8" fill="${b}"/>
    ...
    <ellipse cx="30" cy="196" rx="10" ry="8" fill="${s}"/>`;
  const armRBase = `<ellipse cx="124" cy="136" rx="10" ry="8" fill="${b}"/>
    <rect x="114" y="132" rx="8" width="20" height="36" fill="${b}"/>
    <rect x="120" y="164" rx="6" width="18" height="28" fill="${b}"/>
    <ellipse cx="130" cy="196" rx="10" ry="8" fill="${s}"/>`;
      ...
      <div className="screen-enter" style={{ ...BASE, overflowY:"auto", filter:warmMode?"sepia(0.18) saturate(1.2) brightness(1.02)":"none", transition:"filter 1.2s ease" }}>
        ...
        <div style={{ position:"relative", height:"100vh", display:"flex", flexDirection:"column", overflow:"hidden", paddingBottom:"0" }}>
          ...
          <div style={{ position:"absolute", right:"28%", top:"42%", pointerEvents:"none", zIndex:6, textAlign:"center", transition:"color 1.2s ease" }}>
            <p style={{ fontFamily:"'Inter',sans-serif", fontWeight:300, fontSize:"9px", letterSpacing:".14em", textTransform:"uppercase", color:warmMode?"#C8A870":"#C8A458", opacity:0.85, whiteSpace:"nowrap", transition:"color 1.2s ease" }}>
              {warmMode ? "warm mode on" : "click the lamp"}
            </p>
            <span style={{ display:"block", width:"3px", height:"3px", borderRadius:"50%", background:warmMode?"#C8A870":"#C8A458", margin:"4px auto 0", animation:"pulse 1.5s ease-in-out infinite", transition:"background 1.2s ease" }}/>
          </div>
          {/* Lamp click overlay */}
          ...
          <div style={{ position:"absolute", right:"8%", bottom:"30%", pointerEvents:"none", zIndex:6, textAlign:"center", transition:"color 0.8s ease" }}>
            <p style={{ fontFamily:"'Inter',sans-serif", fontWeight:300, fontSize:"8px", letterSpacing:".12em", textTransform:"uppercase", color:showPlayer?"#C8A870":"#C8A458", opacity:showPlayer?0.9:0.75, whiteSpace:"nowrap", transition:"color 0.8s ease, opacity 0.8s ease" }}>
              {showPlayer ? "music on" : "press radio for music"}
            </p>
            <span style={{ display:"block", width:"3px", height:"3px", borderRadius:"50%", background:showPlayer?"#C8A870":"#C8A458", margin:"4px auto 0", animation:"pulse 1.5s ease-in-out infinite", transition:"background 0.8s ease" }}/>
          </div>
          {/* Radio click overlay */}
          ...
          <div style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"flex-start", justifyContent:"center", padding:"80px 40px 0 clamp(40px,8vw,140px)", position:"relative", zIndex:2 }}>
            <div style={{ maxWidth:"640px", width:"100%", display:"flex", flexDirection:"column", gap:"24px" }}>
              <div>
                <p style={{ fontSize:"9px", letterSpacing:".2em", textTransform:"uppercase", color:"#C8A458", marginBottom:"16px" }}>Communication Training</p>
          ...
          <div style={{ display:"flex", borderBottom:"1px solid #141414" }}>
            ...
            <button onClick={() => setScreen("lang")}
              ...
              <div style={{ textAlign:"center" }}>
                ...
                <p style={{ fontSize:"12px", color:"#C8A458", fontWeight:300 }}>Start a session</p>
              </div>
            </button>
            ...
            <button onClick={() => setExpandedPanel(p => p==="about" ? null : "about")}
              ...
              <div style={{ textAlign:"center" }}>
                ...
                <p style={{ fontSize:"12px", color:"#C8A458", fontWeight:300 }}>What is Profess</p>
              </div>
            </button>
            ...
            <button onClick={() => setExpandedPanel(p => p==="terms" ? null : "terms")}
              ...
              <div style={{ textAlign:"center" }}>
                ...
                <p style={{ fontSize:"12px", color:"#C8A458", fontWeight:300 }}>Terms & Conditions</p>
              </div>
            </button>
          </div>
              ...
              <div style={{ maxWidth:"680px", margin:"0 auto", display:"flex", flexDirection:"column", gap:"0" }}>
                {TERMS_SECTIONS.map((item,i) => (
                  <div key={i} style={{ paddingBottom:"28px", marginBottom:"28px", borderBottom: i < TERMS_SECTIONS.length-1 ? "1px solid #0E0E0E" : "none" }}>
                    <p style={{ fontSize:"13px", fontWeight:500, color:"#D8C178", marginBottom:"8px", letterSpacing:".04em" }}>{item.title}</p>
                  ...
                  <div style={{ display:"flex", flexDirection:"column" }}>
                    {group.items.map((item, ii) => (
                      <button key={ii}
                        ...
                        style={{ background:"none", border:"none", borderBottom:"1px solid #0E0E0E", color:"#C8A458", fontFamily:"inherit", fontSize:"14px", fontWeight:300, padding:"14px 0", textAlign:"left", lineHeight:1.5, transition:"color .15s, padding-left .2s, border-left .2s, background .2s", borderLeft:"0px solid transparent", position:"relative", cursor:"pointer" }}
                        ...
                        onMouseLeave={e=>{ e.currentTarget.style.color="#D8C178"; e.currentTarget.style.paddingLeft="0"; e.currentTarget.style.borderLeft="0px solid transparent"; e.currentTarget.style.background="none"; }}>
                        {item}
                      </button>
                    ))}
                  </div>
          ...
          <div style={{ maxWidth:"520px", width:"100%" }}>
              ...
              {summaryLines.map((line, i) => {
                ...
                return (
                  <div key={i} style={{ display:"flex", gap:"20px", padding:"20px 0", borderBottom:"1px solid #0E0E0E", alignItems:"flex-start" }}>
                    ...
                    <p style={{ fontSize:"14px", lineHeight:1.85, color:"#C8A458" }}>{clean}</p>
                  </div>
                );
              })}
            </div>
            <div style={{ display:"flex", gap:"12px" }}>
              ...
              <button onClick={resetSession}
                ...
                onMouseEnter={e=>{ e.currentTarget.style.borderColor="#3A3530"; e.currentTarget.style.color="#D8C178"; }}
  ...
  const msgList = (fontSize="15px") => messages.map((msg,i) => {
    ...
    return (
      <div key={i} className="msg-enter" style={{ display:"flex", flexDirection:"column", gap:"8px" }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:"5px" }}>
            {segments.map((seg,si) => {
              if (seg.type==="stage") return (
                <p key={si} style={{ fontSize:"12px", fontStyle:"italic", color:"#C8A458", lineHeight:1.75, margin:"4px 0" }}>{seg.text}</p>
              );
              if (seg.type==="section_break") return (
                <div key={si} style={{ display:"flex", alignItems:"center", gap:"14px", margin:"14px 0 8px" }}>
                  ...
                  <span style={{ fontSize:"9px", letterSpacing:".12em", textTransform:"uppercase", color:"#C8A458" }}>coach</span>
                  <div style={{ flex:1, height:"1px", background:"#141414" }}/>
                </div>
              );
              if (seg.type==="coaching") return (
                <p key={si} style={{ fontSize:"13px", lineHeight:2, color:"#C8A458", whiteSpace:"pre-wrap", fontStyle:"italic", paddingLeft:"16px" }}>
        ...
        ) : <p style={{ fontSize, lineHeight:1.9, color:"#C8A458", whiteSpace:"pre-wrap" }}>{renderMarkdown(msg.content)}</p>}
        {isA && innerText && (
    ...
    <div style={{ display:"flex", flexDirection:"column", gap:"8px" }}>
      ...
      <div style={{ display:"flex", gap:"8px", alignItems:"flex-end" }}>
        ...
        <button onClick={toggleMic} className={isListening?"mic-active":""}
          ...
          onMouseEnter={e=>{ if(!isListening){e.currentTarget.style.borderColor="#2A2520";e.currentTarget.style.color="#D8C178";} }}
      ...
      <div style={{ padding:`0 ${isMobile?"16px":"32px"}`, height:isMobile?"48px":"56px", borderBottom:"1px solid #141414", display:"flex", alignItems:"center", gap:"16px", flexShrink:0, position:"relative" }}>
        ...
        <div style={{ position:"absolute", left:"50%", transform:"translateX(-50%)", display:"flex", gap:"8px", alignItems:"center" }}>
          <div onClick={() => { hasOpenedMusic.current = true; setShowPlayer(p => !p); }} style={{ padding:"4px 12px", background:"none", border:`1px solid ${showPlayer?"#C8A870":"#2A2520"}`, borderRadius:"12px", display:"flex", gap:"6px", alignItems:"center", cursor:"pointer", transition:"border-color 0.2s" }}>
            ...
            <span style={{ fontFamily:"'Inter',sans-serif", fontWeight:300, fontSize:"9px", letterSpacing:"0.08em", color:showPlayer?"#C8A870":"#C8A458", transition:"color 0.2s" }}>music</span>
          </div>
          <div onClick={() => { setWarmMode(w => { const next = !w; setRoomMood(next ? "warm" : "neutral"); return next; }); }} style={{ padding:"4px 12px", background:"none", border:`1px solid ${warmMode?"#C8A870":"#2A2520"}`, borderRadius:"12px", display:"flex", gap:"6px", alignItems:"center", cursor:"pointer", transition:"border-color 0.2s" }}>
            ...
            <span style={{ fontFamily:"'Inter',sans-serif", fontWeight:300, fontSize:"9px", letterSpacing:"0.08em", color:warmMode?"#C8A870":"#C8A458", transition:"color 0.2s" }}>warm</span>
          </div>
        </div>
        <div style={{ marginLeft:"auto", display:"flex", gap:"8px", alignItems:"center" }}>
          <button onClick={()=>setIsMobile(p=>!p)} style={{ background:"none", border:"1px solid #1A1A1A", color:"#C8A458", padding:"6px 8px", display:"flex", alignItems:"center", justifyContent:"center", transition:"border-color .2s, color .2s" }}
            onMouseEnter={e=>{ e.currentTarget.style.borderColor="#2A2520"; e.currentTarget.style.color="#D8C178"; }}
            onMouseLeave={e=>{ e.currentTarget.style.borderColor="#1A1A1A"; e.currentTarget.style.color="#C8A458"; }}>
