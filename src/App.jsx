...
function MusicWidget({ activePlaylist, setActivePlaylist, onClose }) {
  return (
    <div style={{ position:"fixed", bottom:0, left:0, right:"auto", zIndex:500, background:"#0A0A0A", border:"1px solid #2A2520", borderRadius:"0 8px 0 0", width:"260px", boxShadow:"0 8px 32px rgba(0,0,0,0.6)" }}>
      {/* Header */}
      ...
      <div style={{ padding:"4px 12px" }}>
        <span style={{ fontFamily:"'Inter',sans-serif", fontWeight:300, fontSize:"9px", color:"#3A3530", letterSpacing:".04em" }}>{PLAYLISTS[activePlaylist].desc}</span>
      </div>
    </div>
  );
}
