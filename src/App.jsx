  ...
  const css = `
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    @media (max-width:640px){
      ...
      .hero-char-row{gap:16px !important;padding:24px 16px !important;overflow-x:auto !important;}
      .hero-char-svg{width:70px !important;height:88px !important;}
      .hero-tooltip{display:none !important;}
      .panels-row{flex-direction:column !important;}
      .panel-btn{min-height:280px !important;border-right:none !important;border-bottom:1px solid #141414 !important;padding:32px 24px !important;}
      .panel-char-box{width:100px !important;}
