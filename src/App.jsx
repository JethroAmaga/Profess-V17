...
export default function Profess() {
  ...
  const hasShownDesktopMusicHint = useRef(false);
  ...
  useEffect(() => {
    if (screen !== "landing" || !isMobile || hasShownDesktopMusicHint.current) return;
    hasShownDesktopMusicHint.current = true;
    setShowDesktopMusicHint(true);
  }, [screen, isMobile]);
  ...
  if (screen === "landing") {
    ...
    return (
      ...
      <div className="screen-enter" style={{ ...BASE, overflowY:"auto", filter:warmMode?"sepia(0.18) saturate(1.2) brightness(1.02)":"none", transition:"filter 1.2s ease" }}>
        ...
        {/* One-time mobile popup: recommend desktop for best music experience */}
        {isMobile && showDesktopMusicHint && (
          <div style={{ position:"fixed", inset:0, zIndex:1000, display:"flex", alignItems:"center", justifyContent:"center", background:"rgba(0,0,0,0.6)", padding:"24px" }}
            ...
            <div onClick={e => e.stopPropagation()} style={{ background:"#0E0E0E", border:"1px solid #2A2520", padding:"28px 24px", maxWidth:"320px", textAlign:"center" }}>
              ...
              <button onClick={() => setShowDesktopMusicHint(false)}
        ...
        <div className="hero-living-room-mobile" style={{ display:"none", width:"100%", height:"220px", overflow:"hidden", opacity: warmMode ? 0.55 : 0.40, transition:"opacity 1.2s ease" }}>
          <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
            ...
            <text x="85.5" y="80" textAnchor="middle" fill="#C8B090" fontSize="2.2" opacity="0.8" letterSpacing="0.4">{lang==="id" ? "PRESS THE RADIO FOR MUSIC" : "PRESS THE RADIO FOR MUSIC"}</text>
