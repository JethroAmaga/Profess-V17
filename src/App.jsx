...
// ─── Backdrop art, generated locally and seeded — used as a soft "set"
// layer behind the character. Was previously sourced from picsum.photos
// (real stock photography by seed); switched to a locally-rendered SVG
// because that depends on a third-party host being reachable, which not
// every deployment/network policy guarantees, and because abstract seeded
// color-light is closer to this product's stated philosophy anyway: scenes
// are emotional shorthand, not literal photography. Each scene still
// carries a small pool of seeds (`scene.photos`) so repeat sessions in the
// same scenario group don't always land on the identical backdrop.
...
const photoFor = (seed, w = 1000, h = 1400, scene = DEFAULT_SCENE) => {
        ...
        <AnimatePresence mode="sync">
          <motion.div key={scene.id}
            ...
            <motion.div style={{ position: "absolute", inset: "-4%", x: photoX, y: photoY }}>
              ...
              <motion.img src={photoFor(photoSeed, 1200, 1600, scene)} alt="" loading="eager"
