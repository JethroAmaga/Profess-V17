...
export default function Profess() {
  ...
  return (
    <div onPointerMove={handlePointerMoveParallax}
      style={{ minHeight: "100dvh", height: "100dvh", overflow: "hidden", background: BG, color: "#F0EDE6", fontFamily: "'Inter',sans-serif", fontWeight: 300, position: "relative" }}>
      <style>{css}</style>
      ...
      <div style={{ position: "absolute", top: "20px", right: "20px", zIndex: 40, display: "flex", alignItems: "center",
