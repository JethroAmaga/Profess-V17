  ...
  const css = `
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    @media (max-width:640px){
      ...
      .hero-char-row{gap:16px !important;padding:64px 16px 32px 56px !important;overflow-x:auto !important;justify-content:flex-start !important;marginLeft:"-40px"}
      ...
      {lang==="id" ? "Lanjutkan" : "Continue"}
        ...
        <div className="hero-living-room-mobile" style={{ display:"none", width:"100%", height:"220px", overflow:"hidden", opacity: warmMode ? 0.55 : 0.40, transition:"opacity 1.2s ease" }}>
          <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
            ...
            <text x="68" y="74" textAnchor="end" fill="#C8B090" fontSize="2" opacity="0.8" letterSpacing="0.3">{lang==="id" ? "PRESS THE RADIO FOR MUSIC" : "PRESS THE RADIO FOR MUSIC"}</text>
