...
export default function Profess() {
  ...
  const [scenePhotoLoaded, setScenePhotoLoaded] = useState({});
        ...
        <AnimatePresence mode="sync">
          <motion.div key={scene.id}
            ...
            <motion.div style={{ position: "absolute", inset: "-4%", x: photoX, y: photoY }}>
              <motion.img src={photoFor(photoSeed, 1200, 1600)} alt=""
                onLoad={() => setScenePhotoLoaded((m) => ({ ...m, [scene.id]: true }))}
                initial={{ opacity: 0, scale: 1.0 }}
                animate={{ opacity: scenePhotoLoaded[scene.id] ? (isMobile ? 0.4 : 1) : 0, scale: 1.12 }}
      ...
      <AnimatePresence>
        {inConversation && (
          <motion.div
            ...
            animate={{ left: isMobile ? "50%" : "94%", top: isMobile ? "4%" : "50%", x: isMobile ? "-50%" : "-100%", y: isMobile ? "0%" : "-50%", opacity: 1, scale: 1 }}
