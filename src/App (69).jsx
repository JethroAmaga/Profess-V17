      ...
      <AnimatePresence>
        {inConversation && (
          <motion.div
            ...
            animate={{ left: isMobile ? "50%" : "94%", top: isMobile ? "9%" : "50%", x: isMobile ? "-50%" : "-100%", y: isMobile ? "0%" : "-50%", opacity: 1, scale: 1 }}
            ...
            <motion.div style={{ scale: lean }}>
              <CharacterFigure size={isMobile ? "min(34dvh, 240px)" : "min(58dvh, 520px)"} />
            </motion.div>
            <div style={{ position: "absolute", top: "100%", marginTop: isMobile ? "10px" : "18px", left: "50%", transform: "translateX(-50%)", textAlign: "center", whiteSpace: "nowrap" }}>
