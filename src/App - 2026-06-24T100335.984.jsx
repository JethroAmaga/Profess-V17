    ...
    if (stage === "intro") return (
      <Overlay footer={
        ...
        <motion.p initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }}
          ...
          style={{ color: "#F0EBE2", fontSize: "14px", lineHeight: 1.9, maxWidth: "38ch", textShadow: "0 2px 16px rgba(0,0,0,.5)" }}>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.6 }}
          style={{ display: "flex", flexWrap: "wrap", gap: "16px", marginTop: "26px" }}>
          {[
