...
// Multiple sources tried in order — browser picks the first one it can play.
// Google Cloud test video is a known-working public embed; Pexels is the
// preferred cinematic source but may be CORS-blocked on some deployments.
const VIDEO_SOURCES = [
