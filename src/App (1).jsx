...
export default function Profess() {
  ...
  if (screen === "landing") return (
    <div className="screen-enter" style={{ ...BASE, display:"flex", flexDirection:"column", overflowY:"auto" }}>
      <style>{css}</style>
      {/* Nav */}
      <nav style={{ position:"fixed", top:0, left:0, right:0, padding:"24px 40px", display:"flex", alignItems:"center", zIndex:100, background:"linear-gradient(to bottom,#080808ee,transparent)" }}>
        <div>
        ...
        <div style={{ marginLeft:"auto", display:"flex", gap:"32px" }}>
          <a href="#about" style={{ fontSize:"11px", color:"#3A3530", textDecoration:"none", letterSpacing:".1em", textTransform:"uppercase", transition:"color .2s" }}
            onMouseEnter={e=>e.currentTarget.style.color="#9A9590"} onMouseLeave={e=>e.currentTarget.style.color="#3A3530"}>About</a>
          <a href="#terms" style={{ fontSize:"11px", color:"#3A3530", textDecoration:"none", letterSpacing:".1em", textTransform:"uppercase", transition:"color .2s" }}
            onMouseEnter={e=>e.currentTarget.style.color="#9A9590"} onMouseLeave={e=>e.currentTarget.style.color="#3A3530"}>Terms</a>
        </div>
      </nav>

      {/* Hero */}
      <div style={{ minHeight:"100vh", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"120px 40px 80px", position:"relative" }}>
        <div style={{ maxWidth:"640px", width:"100%", display:"flex", flexDirection:"column", gap:"32px" }}>
          ...
          <div>
            <button onClick={() => setScreen("lang")}
              style={{ background:"none", border:"1px solid #3A3530", color:"#F0EDE6", fontFamily:"'Playfair Display',serif", fontSize:"14px", fontStyle:"italic", width:"160px", height:"48px", display:"flex", alignItems:"center", justifyContent:"center", letterSpacing:".04em", transition:"background .25s, border-color .25s, color .25s" }}
              onMouseEnter={e=>{ e.currentTarget.style.background="#C8A870"; e.currentTarget.style.borderColor="#C8A870"; e.currentTarget.style.color="#080808"; }}
        ...
        {/* Scroll indicator */}
        <div style={{ position:"absolute", bottom:"48px", left:"50%", transform:"translateX(-50%)", display:"flex", flexDirection:"column", alignItems:"center", gap:"8px", opacity:.35 }}>
          <div style={{ width:"1px", height:"48px", overflow:"hidden", position:"relative" }}>
            <div style={{ position:"absolute", top:0, left:0, width:"1px", height:"100%", background:"#C8A870", animation:"scrollLine 2s ease-in-out infinite" }}/>
          </div>
        </div>
      </div>

      {/* What Profess does */}
      <div style={{ padding:"80px 40px", borderTop:"1px solid #141414", maxWidth:"720px", margin:"0 auto", width:"100%" }}>
        <p style={{ fontSize:"10px", letterSpacing:".14em", textTransform:"uppercase", color:"#3A3530", marginBottom:"48px" }}>What Profess does</p>
        <div style={{ display:"flex", flexDirection:"column", gap:"0" }}>
          {[
            "Embodies your audience and responds exactly as they would.",
            "Steps out to coach after a real exchange — not after every message.",
            "Identifies the most dangerous weakness in your argument, not the easiest one.",
          ].map((s,i) => (
            <div key={i} style={{ padding:"28px 0", borderBottom:"1px solid #141414", display:"flex", gap:"24px", alignItems:"flex-start" }}>
              <span style={{ fontFamily:"'Playfair Display',serif", fontSize:"11px", color:"#3A3530", paddingTop:"3px", flexShrink:0 }}>0{i+1}</span>
              <p style={{ fontFamily:"'Playfair Display',serif", fontSize:"22px", fontWeight:400, color:"#D8D5CE", lineHeight:1.4 }}>{s}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Who it's for */}
      <div style={{ padding:"64px 40px", borderTop:"1px solid #141414", maxWidth:"720px", margin:"0 auto", width:"100%" }}>
        <p style={{ fontSize:"10px", letterSpacing:".14em", textTransform:"uppercase", color:"#3A3530", marginBottom:"32px" }}>Who it's for</p>
        <div style={{ display:"flex", flexWrap:"wrap", gap:"8px" }}>
          {["Job interviews","Thesis defense","Debate practice","Pitch preparation","Press conferences","Salary negotiation","Difficult conversations","First impressions","Networking"].map((tag,i) => (
            <span key={i} style={{ border:"1px solid #1E1E1E", padding:"8px 16px", fontSize:"12px", color:"#5A5550", letterSpacing:".04em" }}>{tag}</span>
          ))}
        </div>
      </div>

      {/* About */}
      <div id="about" style={{ padding:"64px 40px", borderTop:"1px solid #141414", maxWidth:"720px", margin:"0 auto", width:"100%" }}>
        <p style={{ fontSize:"10px", letterSpacing:".14em", textTransform:"uppercase", color:"#3A3530", marginBottom:"24px" }}>About</p>
        <p style={{ fontSize:"15px", lineHeight:1.9, color:"#7A7570", maxWidth:"560px" }}>
      ...
      {/* Terms */}
      <div id="terms" style={{ padding:"64px 40px", borderTop:"1px solid #141414", maxWidth:"720px", margin:"0 auto", width:"100%" }}>
        <p style={{ fontSize:"10px", letterSpacing:".14em", textTransform:"uppercase", color:"#3A3530", marginBottom:"24px" }}>Terms & Conditions</p>
        <div style={{ display:"flex", flexDirection:"column", gap:"20px", maxWidth:"560px" }}>
          {[
            { title:"Nature of the service", body:"Profess is a communication training tool. It is not a licensed therapist, career counselor, legal advisor, or qualified professional of any kind. All feedback is for practice purposes only." },
            { title:"Simulated characters", body:"All characters in Profess are AI simulations. Their responses do not represent the actual standards, judgments, or behavior of any real institution, profession, or individual." },
            { title:"Accuracy and limitations", body:"Profess may make errors in reasoning, miss nuances, or reflect biases present in its training. Do not rely on Profess as the sole basis for any real-world decision." },
            { title:"Content policy", body:"Profess will not portray religious figures, convicted criminals, terrorists, or real public figures in roleplay. Abusive or disrespectful use will result in the session being paused." },
            { title:"Privacy", body:"Conversation content is processed to generate responses and is not stored beyond the active session. No personally identifiable information is retained after the session ends." },
          ].map((item,i) => (
            <div key={i} style={{ paddingBottom:"20px", borderBottom:"1px solid #0E0E0E" }}>
              <p style={{ fontSize:"11px", fontWeight:500, color:"#5A5550", marginBottom:"8px", letterSpacing:".04em" }}>{item.title}</p>
              <p style={{ fontSize:"13px", lineHeight:1.85, color:"#3A3530" }}>{item.body}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Footer */}
      <div style={{ borderTop:"1px solid #141414", padding:"32px 40px", textAlign:"center" }}>
        <p style={{ fontSize:"11px", color:"#2A2520", letterSpacing:".08em" }}>Profess — You cannot move people you do not understand.</p>
      </div>
    </div>
  );
  ...
  if (screen === "lang") return (
    <div className="screen-enter" style={{ ...BASE, display:"flex", height:"100vh", overflow:"hidden" }}>
      <style>{css}</style>
      ...
      {[
        { code:"en", label:"EN", name:"English", sub:"Session in English", accent:"#C8A870", hoverBg:"#0E0E0E", side:"left" },
        { code:"id", label:"ID", name:"Indonesia", sub:"Sesi dalam Bahasa Indonesia", accent:"#C47A8A", hoverBg:"#0E0E0E", side:"right" },
      ].map((opt, idx) => (
        <button key={opt.code}
          ...
          <div style={{ position:"relative", zIndex:1, display:"flex", flexDirection:"column", alignItems:"center", gap:"16px" }}>
            <p style={{ fontSize:"11px", letterSpacing:".14em", textTransform:"uppercase", color:"#3A3530", marginBottom:"8px" }}>{opt.label}</p>
            ...
            <p style={{ fontSize:"13px", color:"#5A5550", letterSpacing:".02em" }}>{opt.sub}</p>
          </div>
        </button>
      ))}
    </div>
  ...
  if (screen === "mode") return (
    <div className="screen-enter" style={{ ...BASE, display:"flex", height:"100vh", overflow:"hidden", position:"relative" }}>
      ...
      <div style={{ position:"fixed", top:"24px", left:"40px", zIndex:50 }}>
        <button onClick={() => setScreen("lang")} style={{ background:"none", border:"none", color:"#3A3530", fontSize:"10px", letterSpacing:".1em", textTransform:"uppercase", display:"flex", alignItems:"center", gap:"5px", transition:"color .2s" }}
      ...
      {[
        ...
        <button key={opt.key}
          ...
          <div style={{ position:"relative", zIndex:1, display:"flex", flexDirection:"column", alignItems:"center", gap:"16px", maxWidth:"320px" }}>
            ...
            <p style={{ fontSize:"13px", color:"#5A5550", lineHeight:1.7, textAlign:"center" }}>{opt.desc}</p>
          </div>
        </button>
      ))}
    </div>
  ...
  if (screen === "disclaimer") {
    ...
    return (
      <div className="screen-enter" style={{ ...BASE, display:"flex", flexDirection:"column" }}>
        <style>{css}</style>
        <div style={{ padding:"0 40px", height:"56px", borderBottom:"1px solid #141414", display:"flex", alignItems:"center", gap:"12px" }}>
          <span style={{ fontFamily:"'Playfair Display',serif", fontSize:"17px", fontWeight:500, letterSpacing:".06em" }}>Profess</span>
          <div style={{ marginLeft:"auto", display:"flex", alignItems:"center", gap:"20px" }}>
            <StepDots/>
            <button onClick={() => setScreen("mode")} style={{ background:"none", border:"none", color:"#3A3530", fontSize:"10px", letterSpacing:".1em", textTransform:"uppercase", display:"flex", alignItems:"center", gap:"5px", transition:"color .2s" }}
              onMouseEnter={e=>e.currentTarget.style.color="#6A6560"} onMouseLeave={e=>e.currentTarget.style.color="#3A3530"}>
        ...
        <div style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", padding:"48px 24px" }}>
          <div style={{ maxWidth:"560px", width:"100%" }}>
            <div style={{ marginBottom:"40px" }}>
              <p style={{ fontSize:"10px", letterSpacing:".14em", textTransform:"uppercase", color:"#3A3530", marginBottom:"12px" }}>{isFormal?(isID?"Formal":"Formal"):(isID?"Sosial":"Social")}</p>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:"16px", marginBottom:"48px" }}>
              ...
              {dc.body.slice(1).map((para,i) => (
                <p key={i} style={{ fontSize:"13px", lineHeight:1.9, color:"#4A4540" }}>{para}</p>
              ))}
            </div>
            <button onClick={() => setScreen("intensity")}
              style={{ width:"100%", height:"48px", background:"none", border:`1px solid ${accent}`, color:accent, fontFamily:"inherit", fontSize:"11px", letterSpacing:".12em", textTransform:"uppercase", transition:"background .2s, color .2s" }}
  ...
  if (screen === "intensity") {
    ...
    const Bars = ({ count, color }) => (
      <div style={{ display:"flex", gap:"4px", alignItems:"flex-end", flexShrink:0, width:"24px" }}>
    ...
    return (
      <div className="screen-enter" style={{ ...BASE, display:"flex", flexDirection:"column" }}>
        ...
        <div style={{ padding:"0 40px", height:"56px", borderBottom:"1px solid #141414", display:"flex", alignItems:"center" }}>
          ...
          <div style={{ marginLeft:"auto", display:"flex", alignItems:"center", gap:"20px" }}>
            <StepDots/>
            <button onClick={() => setScreen("disclaimer")} style={{ background:"none", border:"none", color:"#3A3530", fontSize:"10px", letterSpacing:".1em", textTransform:"uppercase", display:"flex", alignItems:"center", gap:"5px", transition:"color .2s" }}
              onMouseEnter={e=>e.currentTarget.style.color="#6A6560"} onMouseLeave={e=>e.currentTarget.style.color="#3A3530"}>
              <IconArrowLeft/> {isID?"Kembali":"Back"}
            </button>
          </div>
        ...
        <div style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", padding:"40px 24px" }}>
          <div style={{ width:"100%", maxWidth:"480px" }}>
            <div style={{ marginBottom:"40px" }}>
              <p style={{ fontSize:"10px", letterSpacing:".14em", textTransform:"uppercase", color:"#3A3530", marginBottom:"12px" }}>{isID?"Intensitas":"Intensity"}</p>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:"0", border:"1px solid #141414" }}>
              {levels.map((lvl, idx) => (
                <button key={lvl.key}
                  ...
                  onMouseEnter={e=>{ e.currentTarget.style.background="#0E0E0E"; e.currentTarget.querySelector('.lvl-border').style.opacity="1"; }}
                  onMouseLeave={e=>{ e.currentTarget.style.background="#080808"; e.currentTarget.querySelector('.lvl-border').style.opacity="0"; }}>
                  <div className="lvl-border" style={{ position:"absolute", left:0, top:0, bottom:0, width:"3px", background:lvl.color, opacity:0, transition:"opacity .2s" }}/>
                  <Bars count={lvl.bars} color={lvl.color}/>
                  <div>
                    <div style={{ fontFamily:"'Playfair Display',serif", fontSize:"20px", color:lvl.color, marginBottom:"8px" }}>{lvl.label}</div>
                    <div style={{ fontSize:"13px", color:"#4A4540", lineHeight:1.7, maxWidth:"320px" }}>{lvl.desc}</div>
                  </div>
                </button>
              ))}
            </div>
  ...
  if (screen === "scenario") {
    ...
    return (
      <div className="screen-enter" style={{ ...BASE, display:"flex", flexDirection:"column" }}>
        <style>{css}</style>
        <div style={{ padding:"0 40px", height:"56px", borderBottom:"1px solid #141414", display:"flex", alignItems:"center", flexShrink:0 }}>
          <span style={{ fontFamily:"'Playfair Display',serif", fontSize:"17px", fontWeight:500, letterSpacing:".06em" }}>Profess</span>
          <div style={{ marginLeft:"auto", display:"flex", alignItems:"center", gap:"20px" }}>
            <StepDots/>
            <button onClick={() => setScreen("intensity")} style={{ background:"none", border:"none", color:"#3A3530", fontSize:"10px", letterSpacing:".1em", textTransform:"uppercase", display:"flex", alignItems:"center", gap:"5px", transition:"color .2s" }}
              onMouseEnter={e=>e.currentTarget.style.color="#6A6560"} onMouseLeave={e=>e.currentTarget.style.color="#3A3530"}>
              <IconArrowLeft/> {isID?"Kembali":"Back"}
            </button>
          </div>
        ...
        <div style={{ flex:1, overflowY:"auto", padding:"40px" }}>
          <div style={{ maxWidth:"600px", margin:"0 auto" }}>
            <div style={{ marginBottom:"40px" }}>
              ...
              <p style={{ fontSize:"13px", color:"#4A4540", letterSpacing:".02em" }}>
            ...
            <div style={{ marginBottom:"48px" }}>
              <button onClick={() => { setScenario(null); startSession(pendingMode, null); }}
                style={{ width:"100%", background:"none", border:`1px solid ${accent}25`, color:accent, fontFamily:"inherit", fontSize:"13px", padding:"20px 24px", textAlign:"left", letterSpacing:".04em", transition:"border-color .2s, background .2s" }}
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:"40px" }}>
              {groups.map((group, gi) => (
                <div key={gi}>
                  <p style={{ fontSize:"10px", color:"#3A3530", letterSpacing:".12em", textTransform:"uppercase", marginBottom:"16px", paddingBottom:"8px", borderBottom:"1px solid #141414" }}>
                    {group.group}
                  </p>
                  <div style={{ display:"flex", flexDirection:"column" }}>
                    {group.items.map((item, ii) => (
                      <button key={ii}
                        ...
                        style={{ background:"none", border:"none", borderBottom:"1px solid #0E0E0E", color:"#6A6560", fontFamily:"inherit", fontSize:"14px", padding:"14px 0", textAlign:"left", lineHeight:1.5, display:"flex", alignItems:"center", gap:"0", transition:"color .15s, padding-left .2s, border-left .2s", borderLeft:"0px solid transparent", position:"relative", overflow:"hidden" }}
                        onMouseEnter={e=>{ e.currentTarget.style.color="#F0EDE6"; e.currentTarget.style.paddingLeft="8px"; e.currentTarget.style.borderLeft=`2px solid ${accent}`; }}
                        onMouseLeave={e=>{ e.currentTarget.style.color="#6A6560"; e.currentTarget.style.paddingLeft="0"; e.currentTarget.style.borderLeft="0px solid transparent"; }}>
                        {item}
                      </button>
                    ))}
                  </div>
      ...
      <div className="screen-enter" style={{ ...BASE, display:"flex", flexDirection:"column" }}>
        ...
        <div style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", padding:"48px 24px" }}>
          <div style={{ maxWidth:"520px", width:"100%" }}>
            <p style={{ fontSize:"10px", letterSpacing:".14em", textTransform:"uppercase", color:"#3A3530", marginBottom:"12px" }}>
            ...
            <div style={{ display:"flex", gap:"12px" }}>
              <button onClick={() => { setSummary(null); setScreen("session"); }}
                style={{ background:"none", border:`1px solid ${accent}`, color:accent, fontFamily:"inherit", fontSize:"10px", padding:"10px 24px", letterSpacing:".12em", textTransform:"uppercase", transition:"background .2s, color .2s" }}
                onMouseEnter={e=>{ e.currentTarget.style.background=accent; e.currentTarget.style.color="#080808"; }}
                onMouseLeave={e=>{ e.currentTarget.style.background="none"; e.currentTarget.style.color=accent; }}>
                {isID?"Lanjut sesi":"Continue session"}
              </button>
              <button onClick={resetSession}
                style={{ background:"none", border:"1px solid #1E1E1E", color:"#4A4540", fontFamily:"inherit", fontSize:"10px", padding:"10px 24px", letterSpacing:".12em", textTransform:"uppercase", transition:"border-color .2s, color .2s" }}
  ...
  const charAnimBlock = (size) => {
    ...
    return <div key={displayRole+currentMood} className="char-enter" style={{ width:size, height:isLarge?"250px":"72px", opacity:isTransitioning?0:1, transition:"opacity .38s", animation:talkAnim||moodAnim||idleAnim, filter:isSpeaking?`drop-shadow(0 0 ${isLarge?"18px":"8px"} ${charMeta.accent}40)`:"none" }} dangerouslySetInnerHTML={{ __html:charSVG }}/>;
  };
