        ...
        <div style={{ position:"relative", height:"100vh", display:"flex", flexDirection:"column", overflow:"hidden", paddingBottom:"0" }}>
          ...
          <div style={{ position:"absolute", right:0, top:0, height:"100%", width:"45%", opacity: warmMode ? 0.55 : 0.35, transition:"opacity 1.2s ease", pointerEvents:"none", zIndex:1 }}>
            <svg viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice" style={{ width:"100%", height:"100%" }}>
              ...
              {/* Radio body */}
              <rect x="19" y="62" width="13" height="8" rx="1" fill={warmMode?"#3A2010":"#2A1808"} stroke="#3A2410" strokeWidth="0.4"/>
              {/* Radio speaker grille */}
              <line x1="20.5" y1="63.5" x2="27" y2="63.5" stroke="#1A1008" strokeWidth="0.45" opacity="0.9"/>
              <line x1="20.5" y1="65" x2="27" y2="65" stroke="#1A1008" strokeWidth="0.45" opacity="0.9"/>
              <line x1="20.5" y1="66.5" x2="27" y2="66.5" stroke="#1A1008" strokeWidth="0.45" opacity="0.9"/>
              {/* Radio knobs */}
              <circle cx="29" cy="64.2" r="1" fill="#3A2010"/>
              <circle cx="29" cy="67" r="1" fill="#3A2010"/>
              {/* Radio antenna */}
              <line x1="31.2" y1="62" x2="34.5" y2="56.5" stroke="#3A2818" strokeWidth="0.6" style={showPlayer ? {animation:"antennaP 1s ease-in-out infinite"} : {opacity:0.5}}/>
              {/* Radio label */}
              <text x="25.5" y="72.5" fontSize="2.2" textAnchor="middle" fill="#3A2818" opacity="0.6" fontFamily="Inter,sans-serif" letterSpacing="0.5">music</text>
          ...
          {/* Radio click overlay */}
          <div onClick={() => { hasOpenedMusic.current = true; setShowMusicSuggest(false); setShowPlayer(p => !p); }} title="Toggle music player" style={{ position:"absolute", right:"35%", top:"63%", width:"6%", height:"9%", cursor:"pointer", zIndex:7, transform:"translateX(50%)" }}/>
...
function MusicWidget({ activePlaylist, setActivePlaylist, onClose }) {
  return (
    <div style={{ position:"fixed", bottom:"24px", right:"24px", zIndex:500, background:"#0A0A0A", border:"1px solid #2A2520", width:"320px", boxShadow:"0 8px 32px rgba(0,0,0,0.6)" }}>
      {/* Header */}
