    ...
    return (
      <motion.div
        ...
        style={{ position: "absolute", left: isMobile ? "50%" : "9%", top: "50%", transform: isMobile ? "translate(-50%,-50%)" : "translateY(-50%)",
          width, zIndex: 30, maxHeight: "82vh", overflowY: "auto", textAlign: align, paddingTop: "10px",
        ...
        {children}
        {footer && (
          <div style={{ position: "sticky", bottom: 0, paddingTop: "16px", paddingBottom: "16px",
            background: "linear-gradient(to top, #070809 35%, rgba(7,8,9,0.85) 70%, transparent 100%)" }}>
            {footer}
          </div>
        )}
      </motion.div>
  ...
  function StageOverlay() {
    if (stage === "intro") return (
      <Overlay footer={
        ...
        <p style={{ color: INK, fontSize: "14px", lineHeight: 1.8, maxWidth: "38ch" }}>
