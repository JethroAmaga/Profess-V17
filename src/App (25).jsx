...
const PLAYLISTS = [
  ...
  { id: "4cCh0Jz4zZQ", label: "Jazz",    desc: "Jazz cafe vibes" },
  { id: "OZCJ2DxaIJw", label: "Piano",   desc: "Peaceful piano" },
  { id: "P6E5mLWj61Y", label: "Ambient", desc: "Ambient focus" },
  { id: "Bea0yLo4T_4", label: "Study",   desc: "Study music" },
  { id: "EWq1VXEUGIU", label: "Night",   desc: "Night vibes" },
  { id: "6X_OEUFV0v4", label: "Rain",    desc: "Rain & lofi" },
  { id: "mIYzp5rcTvU", label: "Sleep",   desc: "Sleep sounds" },
];
...
function MusicWidget({ activePlaylist, setActivePlaylist, onClose }) {
  return (
    <div style={{ position:"fixed", bottom:0, left:0, right:"auto", zIndex:500, background:"#0A0A0A", border:"1px solid #2A2520", borderRadius:"0 8px 0 0", width:"340px", boxShadow:"0 8px 32px rgba(0,0,0,0.6)" }}>
      {/* Header */}
