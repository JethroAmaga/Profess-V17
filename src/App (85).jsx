...
const SCENES = {
  ...
  social: [
    { id: "relationships", top: "#3A2226", bottom: "#100A0A", floor: "#E08572", mote: "#E0A088", // candlelight rose
      photos: ["candlelit-table", "evening-window", "rose-light", "quiet-dinner"] },
...
// timer. See the IntroVideo component below. Served from /public, so no
// external network host is involved.
const VIDEO_LOOP_SRC = "/video/mountain-loop.mp4";
