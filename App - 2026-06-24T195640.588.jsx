...
export default function Profess() {
    ...
    if (stage === "intro") return (
      <Overlay width="min(560px, 88vw)" align="center" placement="top-center" footer={
        <motion.button onClick={() => setStage("lang")}
          ...
          style={{ display: "inline-flex", alignItems: "center", gap: "10px", background: sessionAccent,
            border: "none", borderRadius: "999px", color: "#15110C", fontSize: "14px", fontWeight: 600,
            letterSpacing: ".01em", padding: "13px 24px 13px 26px", cursor: "pointer", position: "relative", overflow: "hidden",
            boxShadow: `0 3px 10px -4px ${sessionAccent}55` }}>
          ...
          <motion.span variants={{ rest: { x: 0 }, hover: { x: 3 } }} transition={{ duration: 0.25, ease: [0.22, 1, 0.36, 1] }}
            style={{ position: "relative", display: "inline-flex", color: "#15110C" }}>
            <IconArrowRight />
          </motion.span>
        </motion.button>
      }>
        ...
        <motion.div initial={{ scaleX: 0 }} animate={{ scaleX: 1 }} transition={{ duration: 0.9, delay: 0.5, ease: [0.22, 1, 0.36, 1] }}
          style={{ width: "120px", height: "1px", background: `linear-gradient(90deg, transparent, ${sessionAccent}, transparent)`, margin: "0 auto 18px" }} />
  ...
  // Small pill chips for header/footer controls during a session — same
  // social/formal color as the chat panel, so chips never clash with it.
  const pillBg = (sessionMode || pendingMode) === "social" ? "#2A1414" : "#241B0E";
  const pillBorder = (sessionMode || pendingMode) === "social" ? "#4A222088" : "#4A360F88";
          ...
          <motion.div
            ...
            <div style={{ position: "absolute", top: "100%", marginTop: isMobile ? "-6px" : "2px", left: "50%", transform: "translateX(-50%)", textAlign: "center", whiteSpace: "nowrap" }}>
              <TiltBox style={{ boxSizing: "border-box", padding: "5px 13px", borderRadius: "10px",
                ...
                <p style={{ fontFamily: "'Playfair Display',serif", fontStyle: "italic", fontSize: "14px", color: "#F0EDE6" }}>{charMeta.name || charMeta.title}</p>
                <p style={{ fontSize: "9px", color: "#F5F2EC", marginTop: isMobile ? "0px" : "-3px" }}>{charMeta.title}</p>
      ...
      {inConversation && (
        <>
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.22, 1, 0.36, 1] }}
            ...
            <motion.button onClick={() => setStage("intro")} whileHover={{ opacity: 0.85 }} whileTap={{ scale: 0.96 }}
              style={{ background: pillBg, border: `1px solid ${pillBorder}`, borderRadius: "999px", color: "#FFF", fontWeight: 700, fontSize: "12px", fontFamily: "'Inter',sans-serif", padding: "6px 14px" }}>Profess</motion.button>
            <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
              <motion.button onClick={() => setTranscriptOpen(o => !o)}
                whileHover={{ opacity: 0.85 }} whileTap={{ scale: 0.96 }}
                transition={{ duration: 0.18 }}
                style={{ background: pillBg, border: `1px solid ${pillBorder}`, borderRadius: "999px", color: "#FFF", fontWeight: 700, fontSize: "11px", padding: "6px 12px" }}>
              ...
              <motion.button onClick={() => setSpeechEnabled(s => !s)} whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}
                style={{ background: pillBg, border: `1px solid ${pillBorder}`, borderRadius: "50%", width: "30px", height: "30px", display: "flex", alignItems: "center", justifyContent: "center", color: "#FFF" }}>{speechEnabled ? <IconVolume/> : <IconMute/>}</motion.button>
              <motion.button onClick={resetSession} whileHover={{ scale: 1.1, rotate: -25 }} whileTap={{ scale: 0.9 }}
                style={{ background: pillBg, border: `1px solid ${pillBorder}`, borderRadius: "50%", width: "30px", height: "30px", display: "flex", alignItems: "center", justifyContent: "center", color: "#FFF" }}><IconRefresh/></motion.button>
            </div>
          </motion.div>
            ...
            {transcriptOpen && (
              <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }}
                ...
                <TiltBox style={{ height: "100%", overflowY: "auto", padding: "20px 24px", boxSizing: "border-box", borderRadius: "18px",
                  background: (sessionMode || pendingMode) === "social" ? "#2A1414" : "#241B0E",
                  border: `1px solid ${(sessionMode || pendingMode) === "social" ? "#4A222088" : "#4A360F88"}`,
          ...
          <div style={{ position: "absolute", left: 0, right: 0, bottom: 0, padding: "16px 28px 22px", zIndex: 10, background: "linear-gradient(to top, rgba(7,8,9,0.92), transparent)" }}>
            <div style={{ display: "flex", justifyContent: "flex-end", gap: "8px", marginBottom: "8px" }}>
              {lastExchange && <motion.button onClick={tryAgain} whileHover={{ opacity: 0.85 }} whileTap={{ scale: 0.95 }} style={{ background: pillBg, border: `1px solid ${pillBorder}`, borderRadius: "999px", color: "#FFF", fontWeight: 700, fontSize: "11px", padding: "6px 12px" }}>{lang === "id" ? "Coba lagi" : "Try again"}</motion.button>}
              <motion.button onClick={endSession} whileHover={{ opacity: 0.85 }} whileTap={{ scale: 0.95 }} style={{ background: pillBg, border: `1px solid ${pillBorder}`, borderRadius: "999px", color: "#FFF", fontWeight: 700, fontSize: "11px", padding: "6px 12px" }}>{lang === "id" ? "Akhiri" : "End session"}</motion.button>
            </div>
